...
char reqAcc[11];int flag=0;char choise;
...
do{
   ...
   do{
         ...
         gets(username);
         flag_1=0;
         flag_1=checkName(username);}while(flag_1==0);
   do{
         flag_1==0;
...
do{
   ...
   /// modify the required account
    ...
    {
    int place=loadAccIndex(accReqMod);char choice;
